...
class Question15Widget extends StatefulWidget {
  const Question15Widget({Key key}) : super(key: key);

  @override
  _Question15WidgetState createState() => _Question15WidgetState();
}

class _Question15WidgetState extends State<Question15Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Question15'});
  }
