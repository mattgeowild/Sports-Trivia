...
class Question15CopyCopyCopyWidget extends StatefulWidget {
  const Question15CopyCopyCopyWidget({Key key}) : super(key: key);

  @override
  _Question15CopyCopyCopyWidgetState createState() =>
      _Question15CopyCopyCopyWidgetState();
}

class _Question15CopyCopyCopyWidgetState
    extends State<Question15CopyCopyCopyWidget> with TickerProviderStateMixin {
  final animationsMap = {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Question15CopyCopyCopy'});
  }
