...
class Question16Widget extends StatefulWidget {
  const Question16Widget({Key key}) : super(key: key);

  @override
  _Question16WidgetState createState() => _Question16WidgetState();
}

class _Question16WidgetState extends State<Question16Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Question16'});
  }
